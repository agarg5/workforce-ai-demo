    ...
    <div className="px-3">
      ...
      <ul className="space-y-1">
        {COMPANY_DOCS.map((doc) => (
          <li key={doc.name}>
            <div className="group flex items-start gap-2.5 rounded-lg px-2 py-2 transition hover:bg-white/5">
      ...
      <button className="mt-2 flex w-full items-center justify-center gap-1.5 rounded-lg border border-dashed border-white/15 px-2 py-2 text-xs font-medium text-slate-400 transition hover:border-white/30 hover:text-slate-200">
